						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="filter">
									<td></td>
									<td>
										<input type="text" class="form-control form-filter input-sm" name="issue_id">
									</td>
									<td>
									...
									<td>
										<input type="text" class="form-control form-filter input-sm" name="issue">
									</td>
									<td></td>
									<td><input type="text" class="form-control form-filter input-sm" name="staff_name"></td>
									<td></td>
								</tr>
								</thead>
								<tbody>
